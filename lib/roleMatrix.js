...
export const ROLE_MATRIX = [
  ...
  },
  {
    ...
    rows: [
      ...
      row("Duties: fruit, jerseys and the goalkeeper", "yes", "no", "yes", "own", "yes", "Coaches assign or clear any duty; parents claim fruit or jersey duty for their own family (never the goalkeeper) and can hand it back"),
      row("Edit fixtures, scores, squad, staff, team details", "yes", "no", "yes", "no", "yes"),

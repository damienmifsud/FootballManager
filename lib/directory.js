...
// (league config, fixtures, sync) and to authorise marking any player's RSVP.
// Admins are coaches everywhere; otherwise the email must resolve to a
// "coach" membership for this exact slug.
